...
export default function Footer() {
  return (
    <footer className="border-t border-[#dddddd] mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-2">
            <Logo size="md" showTagline />
            <p className="text-body-sm text-[#6a6a6a] mt-4 max-w-xs leading-relaxed">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-[#f7f7f7] border border-[#dddddd] flex items-center justify-center text-[#6a6a6a] hover:text-[#222222] hover:border-[#222222] transition-all"
          ...
          <div>
            <h4 className="text-[#222222] font-semibold text-body-sm mb-4">Explore</h4>
            <ul className="space-y-2.5 text-body-sm text-[#6a6a6a]">
              <li><Link href="/" className="hover:text-[#222222] transition-colors duration-200">Discover</Link></li>
              <li><Link href="/gift" className="hover:text-[#222222] transition-colors duration-200">Gift Cards</Link></li>
              <li><Link href="/saved" className="hover:text-[#222222] transition-colors duration-200">Saved</Link></li>
              <li><Link href="/bookings" className="hover:text-[#222222] transition-colors duration-200">Bookings</Link></li>
            </ul>
          </div>
