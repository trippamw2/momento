  ...
  return (
    <footer className="border-t border-white/[0.1] mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-body-sm text-[#CBD5E1] mt-4 max-w-xs leading-relaxed">
              Discover, book, gift and enjoy unforgettable real-life experiences curated for every mood and occasion across Malawi. Live the Moment.
            </p>
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-[#111827] border border-white/[0.1] flex items-center justify-center text-[#64748B] hover:text-white hover:border-white/[0.2] transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-body-sm text-[#CBD5E1]">
              <li><Link href="/discover" className="hover:text-white transition-colors duration-200">Discover</Link></li>
              <li><Link href="/experiences" className="hover:text-white transition-colors duration-200">Experiences</Link></li>
        ...
        <div className="mt-12 pt-6 border-t border-white/[0.1] flex flex-col sm:flex-row items-center justify-between gap-4 text-caption text-[#64748B]">
