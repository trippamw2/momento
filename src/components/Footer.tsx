      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-body-sm text-[#A1A1AA] mt-4 max-w-xs leading-relaxed">
            ...
            <div className="flex items-center gap-3 mt-5">
              {["instagram", "twitter", "facebook"].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-9 h-9 rounded-xl bg-[#111827] border border-[rgba(255,255,255,0.06)] flex items-center justify-center text-[#A1A1AA] hover:text-white hover:bg-[#1a2235] transition-all"
                  aria-label={s}
                >
                  {s === "instagram" && (
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-body-sm text-[#A1A1AA]">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-body-sm text-[#A1A1AA]">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-200">List Your Experience</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Partner Resources</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-[rgba(255,255,255,0.06)] flex flex-col sm:flex-row items-center justify-between gap-4 text-caption text-[#6B7280]">
          <p>&copy; {new Date().getFullYear()} Momento. All rights reserved.</p>
          <p className="flex items-center gap-1">
            Made with <span className="text-[#FF2D7A]">♥</span> in Malawi
          </p>
        </div>
      </div>
    </footer>
