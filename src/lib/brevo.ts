...
export async function sendBookingConfirmation(params: {
  ...
  return sendEmail({
    ...
    subject: `Booking Confirmed — ${params.experienceTitle} ✦ Experio`,
...
export async function sendBookingCancellation(params: {
  ...
  return sendEmail({
    to: [{ email: params.email, name: params.guestName }],
    subject: `Booking Cancelled — ${params.experienceTitle} ✦ Experio`,
...
export async function sendGiftCardEmail(params: {
  ...
  return sendEmail({
    ...
    subject: `You've Received an Experio Gift Card from ${params.senderName}! 🎁`,
