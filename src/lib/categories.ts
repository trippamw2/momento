...
export const MOMENTO_CATEGORIES = [
  ...
  { key: "Chill" as MomentoCategory, emoji: "ðŸŒ¿", label: "Chill", description: "Coffee shops, spas, beaches, cafÃ©s", accent: "from-emerald-400 to-teal-500" },
  { key: "Celebrate" as MomentoCategory, emoji: "ðŸŽ‰", label: "Celebrate", description: "Birthdays, nightlife, concerts, private dining", accent: "from-amber-400 to-orange-500" },
  { key: "Escape" as MomentoCategory, emoji: "ðŸŒ", label: "Escape", description: "Weekend getaways, lodges, safaris, adventures", accent: "from-blue-400 to-cyan-500" },
] as const;
