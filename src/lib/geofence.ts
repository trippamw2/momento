...
export const MOCK_GEOFENCE_ZONES: GeofenceZone[] = [
  {
    ...
    radius: 2000,
    experienceIds: ["pool-lunch", "date-night", "brunch-experience", "girls-day-out", "birthday-experience", "adventure-day", "rooftop-dining", "coffee-brunch"],
  },
  {
    ...
    radius: 2000,
    experienceIds: ["sunset-cruise", "spa-day", "wine-tasting", "couples-massage", "private-beach-dinner"],
  },
  {
    id: "lake-malawi-south",
    name: "Lake Malawi · Cape Maclear",
    center: { lat: -14.0167, lng: 34.8333 },
    radius: 3000,
    experienceIds: ["staycation", "glamping-weekend", "lake-kayaking"],
  },
  {
    id: "blantyre-outskirts",
    name: "Blantyre Nature & Wellness",
    center: { lat: -15.7000, lng: 34.9500 },
    radius: 4000,
    experienceIds: ["wellness-retreat", "sunset-safari"],
  },
  {
    id: "lilongwe-creative",
    name: "Lilongwe Arts & Culture",
    center: { lat: -13.9800, lng: 33.7900 },
    radius: 2000,
    experienceIds: ["paint-sip", "photoshoot"],
  },
];
