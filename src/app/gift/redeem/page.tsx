      ...
      <div className="rounded-2xl bg-[#111827] border border-white/[0.08] p-6 sm:p-8 mb-8">
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            <input
              type="text"
              placeholder="Enter code (e.g. XPRO-XXXXXXXX)"
              value={code}
              ...
              <div className="p-5 rounded-2xl bg-red-500/10 border border-red-500/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-caption text-red-300 mt-0.5">Please check the code and try again. Codes are format: XPRO-XXXXXXXX</p>
                  </div>
                </div>
              </div>
            ) : card ? (
