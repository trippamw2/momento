    ...
    <div className="p-6 sm:p-8 rounded-3xl bg-[#111827] border border-white/[0.08] shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold shadow-lg shrink-0 ${
            streak.current > 0 ? "bg-gradient-to-br from-orange-500 to-red-500 text-white" : "bg-[#1E293B] text-[#64748B]"
          }`}>
            {streak.current > 0 ? "≡" : "···"}
          </div>
          <div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              { icon: "✎", title: "Write Reviews", desc: "50 pts per review", link: null },
