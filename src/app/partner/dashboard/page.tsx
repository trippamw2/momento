        ...
        <div className="max-w-lg mx-auto px-4 sm:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              ...
              className="px-6 py-3 rounded-xl border border-white/[0.08] text-[#F1F5F9] font-semibold text-body-sm hover:bg-white/[0.05] transition-all"
            >
              Become a Partner
            </Link>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          ...
          <div className="flex items-center gap-3 mt-4 sm:mt-0">
            <Link
              href="/partner/list-experience"
              className="px-5 py-2.5 rounded-xl bg-[#FF2D7A] text-white font-semibold text-body-sm hover:shadow-[0_4px_16px_rgba(255,56,92,0.3)] transition-all flex items-center gap-2"
            >
            ...
            <Link
              ...
              className="px-5 py-2.5 rounded-xl border border-white/[0.08] text-[#F1F5F9] font-semibold text-body-sm hover:bg-white/[0.05] transition-all"
            >
              Resources
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {/* Bookings Table */}
          <div className="lg:col-span-2 rounded-2xl border border-white/[0.08] bg-[#111827] overflow-hidden">
            <div className="p-5 border-b border-white/[0.08]">
              <h2 className="text-heading-sm font-bold text-[#F1F5F9]">Recent Bookings</h2>
            </div>
            ...
            <div className="p-4 border-t border-white/[0.08] text-center">
              <button className="text-body-sm text-[#FF2D7A] font-medium hover:underline">
                View All Bookings →
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-white/[0.08] bg-[#111827] p-5">
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-[#FF2D7A]/10 flex items-center justify-center text-lg group-hover:bg-[#FF2D7A]/20 transition-colors">
                    ➕
                  </div>
                  <div>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#111827] overflow-hidden">
          <div className="p-5 border-b border-white/[0.08] flex items-center justify-between">
            <h2 className="text-heading-sm font-bold text-[#F1F5F9]">Your Experiences</h2>
            <Link
              href="/partner/list-experience"
              className="text-body-sm text-[#FF2D7A] font-medium hover:underline"
            >
              Manage All →
            </Link>
          </div>
          <div className="divide-y divide-[#dddddd]/50">
            {experiencesLoading ? (
              ...
              <div className="p-8 text-center">
                ...
                <Link href="/partner/list-experience" className="text-body-sm text-[#FF2D7A] font-medium hover:underline">
                  List your first experience →
                </Link>
              </div>
            ) : experiences.map((exp, i) => (
              <div key={exp.id || i} className="p-4 hover:bg-white/[0.05] transition-colors flex items-center justify-between">
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-10 h-10 rounded-xl bg-[#FF2D7A]/10 flex items-center justify-center text-body-sm font-bold text-[#FF2D7A] flex-shrink-0">
