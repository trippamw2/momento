      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          ...
          <div className="flex items-center gap-3 mt-4 sm:mt-0">
            <Link
              href="/partner/list-experience"
              className="px-5 py-2.5 rounded-xl bg-[#FF0F73] text-white font-semibold text-body-sm hover:shadow-[0_4px_16px_rgba(255, 15, 115, 0.3)] transition-all flex items-center gap-2"
            >
            ...
            {experiencesLoading ? (
              ...
              <div key={exp.id || i} className="p-4 hover:bg-white/[0.05] transition-colors flex items-center justify-between">
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-10 h-10 rounded-xl bg-[#FF0F73]/10 flex items-center justify-center text-body-sm font-bold text-[#FF0F73] flex-shrink-0">
